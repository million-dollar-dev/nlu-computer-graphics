...
//		pyraLocZ = -3.0f;
		...
		brickTexture = Utils.loadTexture("DaylightSkyBox.png");
	}
...
//		gl.glGenerateTextureMipmap(GL_TEXTURE_2D);
	...
	private void setupVertices() {
		...
		gl.glBindBuffer(GL_ARRAY_BUFFER, vbo[0]);
		FloatBuffer pyrBuf = Buffers.newDirectFloatBuffer(vertexPositions);
		gl.glBufferData(GL_ARRAY_BUFFER, pyrBuf.limit() * 4, pyrBuf, GL_STATIC_DRAW);

		gl.glBindBuffer(GL_ARRAY_BUFFER, vbo[1]);
		FloatBuffer pTexBuf = Buffers.newDirectFloatBuffer(cubeTextureCoord);
