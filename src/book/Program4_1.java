...
public class Program4_1 extends JFrame implements GLEventListener {
	...
	private String vShaderSource = "vertSBGPT.glsl";
	private String fShaderSource = "fragSBGPT.glsl";
	...
	public void init(GLAutoDrawable drawable) {
        ...
        // Setup View Matrix
        vMat.identity();
        vMat.lookAt(new Vector3f(cameraX, cameraY, cameraZ), new Vector3f(0.0f, 0.0f, 0.0f), new Vector3f(0.0f, 1.0f, 0.0f));
	...
	public void display(GLAutoDrawable drawable) {
        ...
        // Update View Matrix
        vMat.identity().lookAt(new Vector3f(cameraX, cameraY, cameraZ), new Vector3f(0.0f, 0.0f, 0.0f), new Vector3f(0.0f, 1.0f, 0.0f));
